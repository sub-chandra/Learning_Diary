...
```bash
git init
git init <Path> # Initialization the Repository
git add .
git commit -m "Massage" # Only can use " " in cmd(Windows)
...
# Enter three times
# The key may create at 
# --------------------------------------------
# Windows:  C:/Users/Lenovo/.ssh/id_rsa.pub 
...
### `git pull`
```bash 
# Pull Centern Fold or File. Not all Repo
...
>[!ERROR] <font color='#cc1111'> warning: LF will be replaced by CRLF in database/migrations/2017_07_04_1004</font>
>```bash
>git config --global core.autocrlf false
>```

>[!ERROR] <font color='#cc1111'>Remote: error: GH007: Your push would publish a private email address.</font>
>==Step:==
> 1. Sign GitHub
> 2. Setting =>emails
> 3. *Uncheck*  Keep my email address private
>
